...
def xiaoqu_parse(response):
    ...
    # 'body > div.body-wrapper > div.basic-container > div.info-container > div.info-tb-container > table > tbody > tr:nth-child(1) > td:nth-child(4)'
    result['address'] = jpy('body>div.body-wrapper>div.basic-container>div.info-container> div.info-tb-container>table.info-tb>tr:nth-child(1)>td:nth-child(4)').text()
    result['name'] = jpy('body>div.body-wrapper>div.title-bar>span.title').text()
    # result['address'] = jpy('body>div.body-wrapper>div.title-bar>span.addr').text()
    result['reference_price'] = jpy('body>div.body-wrapper>div.basic-container>div.info-container>div>span.price').text()
    result['times'] = jpy('body>div.body-wrapper>div.basic-container>div.info-container> div.info-tb-container>table>tr:nth-child(5)>td:nth-child(2)').text()
